...
export default class PersonalDetailsPage extends CheckinBasePage {
  ...
  firstNameField(): Locator {
    return this.getByID("firstName");
  }
  lastNameField(): Locator {
    return this.getByID("lastName");
  }
  dayField(): Locator {
    return this.page.locator('[name="day"]');
  }
  monthField(): Locator {
    return this.page.locator('[name="month"]');
  }
  yearField(): Locator {
    return this.page.locator('[name="year"]');
  }
